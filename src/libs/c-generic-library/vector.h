...
/**
 * @fn int8_t insert_at_Vector(Vector *, void *,u_int32_t)
 ...
 */
int8_t insert_at_Vector(Vector * vec, void *obj, u_int32_t loc);
...
/**
 * @fn void *return_at_Vector(Vector *vec, u_int32_t loc)
 ...
 * point
 */
void *return_at_Vector(Vector * vec, u_int32_t loc);
