...
int8_t set_hash_OHTable(OHTable *table, u_int32_t (*hash)(void *,size_t));
...
int8_t set_hash_CHTable(CHTable *table, u_int32_t (*hash)(void *,size_t));
int8_t set_probe_CHTable(CHTable *table, u_int32_t (*prob)(u_int32_t));
...
u_int32_t char_hash(void *key, size_t len);
u_int32_t num_hash(void *key, size_t len);
/* Generic probing techniques */
u_int32_t linear_probing(u_int32_t num);
u_int32_t quadratic_probing(u_int32_t num);
