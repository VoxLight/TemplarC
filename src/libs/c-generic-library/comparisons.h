...
CMPFUNC_PROTO(u_int8_t);
CMPFUNC_PROTO(u_int16_t);
CMPFUNC_PROTO(u_int32_t);
CMPFUNC_PROTO(u_int64_t);
...
CMPFUNC_IMPL(u_int8_t)
CMPFUNC_IMPL(u_int16_t)
CMPFUNC_IMPL(u_int32_t)
CMPFUNC_IMPL(u_int64_t)
